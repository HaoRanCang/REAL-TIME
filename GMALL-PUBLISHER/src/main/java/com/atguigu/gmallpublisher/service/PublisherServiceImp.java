...
public class PublisherServiceImp implements PublisherService{
    ...
    public Map<String, Object> getSaleDetailAndAgg(String date, String keyword, int startpage, int size) throws IOException {
        ...
        Search search = new Search
                .Builder(ESUtil.getDSL(date, keyword, startpage, size))
        ...
        List<TermsAggregation.Entry> genderBuckets = searchResult.getAggregations().getTermsAggregation("group_by_user_gender").getBuckets();
        ...
        List<TermsAggregation.Entry> ageBuckets = searchResult.getAggregations().getTermsAggregation("group_by_user_age").getBuckets();
